##Retreiving the Data to the Dataframe
...
#Binding both the dataframes together 
data <- rbind(df1,df2)
#remove NaN from AppData3, then using data as the final dataset
...
##checking the Duplicates and removing them accordingly
data <- unique(data)
